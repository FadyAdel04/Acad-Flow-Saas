...
const SecretaryStudents      = lazy(() => import('../pages/secretary/SecretaryStudents'));
const MaterialAssignmentCenter = lazy(() => import('../pages/shared/MaterialAssignmentCenter'));
      ...
      <Routes>
        ...
        <Route element={<ProtectedRoute allowedRoles={['admin']} />}>
          <Route path="/admin" element={<AdminLayout />}>
            ...
            <Route path="material-assignments" element={<MaterialAssignmentCenter portal="admin" />} />
        ...
        <Route element={<ProtectedRoute allowedRoles={['secretary']} />}>
          <Route path="/secretary">
            ...
            <Route path="material-assignments" element={<MaterialAssignmentCenter portal="secretary" />} />
          </Route>
        </Route>
