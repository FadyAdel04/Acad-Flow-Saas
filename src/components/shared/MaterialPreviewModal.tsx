            ...
            <div className="w-full h-full relative group/pdf overflow-hidden">
              ...
              {!pdfFallback && (
                <button
                  ...
                  className="absolute bottom-3 right-3 z-20 px-3 py-2 rounded-lg bg-black/70 text-white text-[10px] font-black uppercase tracking-widest"
                >
                  Direct PDF mode
                </button>
              )}
