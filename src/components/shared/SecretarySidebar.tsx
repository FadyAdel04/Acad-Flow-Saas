          ...
          {menuItems.map((item) => {
            ...
            return (
              <button
                ...
                className={`w-full flex items-center justify-between group p-4 rounded-2xl transition-all relative overflow-hidden ${active ? 'bg-[#1A1A1A] text-white' : 'hover:bg-[#F5F5F0] text-[#1A1A1A]/60'
                  }`}
              >
