  ...
  const translations: Record<string, Record<string, any>> = {
    ...
    de: {
      ...
      aboutUs: {
        eyebrow: 'Über uns',
        title: 'Wer wir sind',
        p1: 'Acad Flow Klub ist ein Lernraum, der sich darauf konzentriert, durch strukturierte Praxis, Beständigkeit und eine unterstützende Gemeinschaft ein starkes Fundament für die Kommunikation aufzubauen.',
    ...
    <motion.div initial="hidden" animate="visible" variants={cv} className="min-h-screen bg-[#F5F5F0]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-end">
            <div className="lg:col-span-7">
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-black tracking-tighter text-[#1A1A1A] leading-none uppercase mt-4">
                ...
                <span className="text-[#C62828]">{t(active?.heroSubtitle || 'Acad Flow Klub.')}</span>
              </h1>
      ...
      <SectionCard
        ...
        copy={
          <>
            <p>
              {t(active?.aboutUs?.p1 || 'Acad Flow Klub is a learning space focused on building a strong foundation for communication through structured practice, consistency, and a supportive community.')}
            </p>
            <p>
        ...
        imageSrc={about}
        imageAlt={t(active?.aboutUs?.title || "About Acad Flow Klub")}
      />
      ...
      <SectionCard
        ...
        copy={
          <>
            ...
            <p>
              <span className="font-black text-white">{t(active?.locations?.contactLabel || 'Contact:')}</span> +20 15 15638830 • Acad Flowklub@gmail.com
            </p>
            <p>
              {t(active?.locations?.followText || 'For events and updates, follow our handles:')} <span className="font-black text-white">Acad Flow.klub</span>.
            </p>
          </>
        }
        imageSrc={map}
      ...
      <SectionCard
        ...
        copy={
          <>
            <p>
              {t(active?.careers?.p1 || 'If you want to collaborate or join our team, contact us at')} <span className="font-black text-[#1A1A1A]">Acad Flowklub@gmail.com</span>{' '}
