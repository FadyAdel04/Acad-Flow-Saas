                  ...
                  {exams.map(e => (
                    <motion.div key={e.id} variants={ci} whileHover={{ y: -4 }}
                      ...
                      <span className="text-[8px] font-black uppercase tracking-widest text-[#1A1A1A]/30 border-l border-[#1A1A1A]/10 pl-3">
                        By {e.instructor?.name || 'Acad Flow Admin'}
                      </span>
                    ...
                    {submissions.map((r) => (
                      <tr key={r.id} className="hover:bg-[#F5F5F0]/50">
                        ...
                        <td className="px-6 py-4">
                          <span
                            className={`text-[9px] font-black uppercase px-2 py-1 rounded-full ${r.review_status === 'completed' ? 'bg-green-50 text-green-700' : 'bg-amber-50 text-amber-900'
                              }`}
                          >
